...
\section{Projects}
  ...
  \resumeProjectHeading
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Collaborated with a team of four to develop a full-stack MERN application for a simulated enterprise, meeting specified business requirements.}
            ...
            \resumeItem{Developed a responsive React client with a Recharts analytics dashboard to visualize key metrics, which improved user task completion time by 20\% and informed strategic decisions.}
